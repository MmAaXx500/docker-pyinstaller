...
ENV OPENSSL_BUILD_ARG03='linux-generic32'
ENV OPENSSL_BUILD_ARG04='386'
ENV OPENSSL_BUILD_ARG05='-m32'
ENV OPENSSL_BUILD_ARG06='-march=i686'
ENV OPENSSL_BUILD_ARG07='no-afalgeng'
ENV OPENSSL_BUILD_ARG08='shared'
ENV OPENSSL_BUILD_ARG09='zlib'
...
ENV PYTHON_BUILD_ARG05='--host=i686-pc-linux-gnu'
ENV PYTHON_BUILD_ARG06='--build=i686-pc-linux-gnu'
ENV PYTHON_BUILD_ARG07='CPPFLAGS=-O3 -m32 -march=i686'
