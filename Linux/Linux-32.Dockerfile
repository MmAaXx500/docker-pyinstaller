...
ENV OPENSSL_BUILD_ARG07='shared'
ENV OPENSSL_BUILD_ARG08='zlib'
...
ENV PYTHON_BUILD_ARG06='--host=i686-pc-linux-gnu'
ENV PYTHON_BUILD_ARG07='--build=i686-pc-linux-gnu'
ENV PYTHON_BUILD_ARG08='CPPFLAGS=-m32 -march=i686'
